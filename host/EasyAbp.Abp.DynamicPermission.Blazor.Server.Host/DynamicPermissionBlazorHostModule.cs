...
using EasyAbp.Abp.DynamicPermission.Blazor.Server.Host.Menus;
...
namespace EasyAbp.Abp.DynamicPermission.Blazor.Server.Host
{
    [DependsOn(
        ...
        typeof(AbpDynamicPermissionBlazorServerModule)
    )]
        ...
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    ...
                    typeof(AbpDynamicPermissionDomainModule).Assembly,
                    typeof(AbpDynamicPermissionDomainSharedModule).Assembly,
                    typeof(AbpDynamicPermissionApplicationModule).Assembly,
                    typeof(AbpDynamicPermissionApplicationContractsModule).Assembly,
                    typeof(DynamicPermissionBlazorHostModule).Assembly
                );
            });
        }
        ...
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            Configure<AbpBundlingOptions>(options =>
            {
                ...
                options.StyleBundles.Configure(
                    ...
                    bundle =>
                    {
                        ...
                        bundle.AddFiles("/EasyAbp.Abp.DynamicPermission.Blazor.Server.Host.styles.css");
                    }
                );
            });
            ...
            if(hostingEnvironment.IsDevelopment())
            {
                Configure<AbpVirtualFileSystemOptions>(options =>
                {
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<DynamicPermissionBlazorHostModule>(hostingEnvironment.ContentRootPath);
                });
            }
