...
namespace EasyAbp.Abp.DynamicPermission
{
    ...
    public class DynamicPermissionWebHostModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(DynamicPermissionResource),
                    typeof(AbpDynamicPermissionDomainSharedModule).Assembly,
                    typeof(AbpDynamicPermissionApplicationContractsModule).Assembly,
                    typeof(DynamicPermissionWebHostModule).Assembly
                );
            });
        }
        ...
        private void ConfigureMenu(IConfiguration configuration)
        {
            ...
            {
                options.MenuContributors.Add(new DynamicPermissionWebHostMenuContributor(configuration));
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
        {
            context.Services.AddAuthentication(options =>
                ...
                .AddAbpOpenIdConnect("oidc", options =>
                {
                    ...
                    options.Scope.Add("DynamicPermission");
                });
        }
        ...
        private void ConfigureAutoMapper()
        {
            ...
            {
                options.AddMaps<DynamicPermissionWebHostModule>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpDynamicPermissionDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}EasyAbp.Abp.DynamicPermission.Domain", Path.DirectorySeparatorChar)));
            ...
            IWebHostEnvironment hostingEnvironment)
        {
            if (!hostingEnvironment.IsDevelopment())
            {
                ...
                context.Services
                    .AddDataProtection()
                    .PersistKeysToStackExchangeRedis(redis, "DynamicPermission-Protection-Keys");
            }
        }
        ...
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "DynamicPermission API");
            });
